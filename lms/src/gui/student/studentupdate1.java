				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						if (valobj.fun(textField.getText())) {
							...
							try {
								if (obj2.isstudent(id)) {
									studentupdate2 obj = new studentupdate2(id);
									obj.setVisible(true);
									studentalgo obj21 = new studentalgo();
									obj21.set(obj, textField.getText());
									dispose();
								} else {
